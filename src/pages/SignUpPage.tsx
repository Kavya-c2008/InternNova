...
export const SignUpPage: React.FC = () => {
  const { signUp, signInDemoGoogle } = useApp();
      ...
      <div className="max-w-md w-full space-y-8 bg-white p-8 sm:p-10 rounded-3xl border border-slate-200/90 shadow-xl">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-500">
            Apply to top tech internships and track your candidate pipeline
          </p>
        </div>
        ...
        <p className="text-center text-xs text-slate-500 pt-2">
          ...
          <Link to="/signin" className="text-indigo-600 hover:text-indigo-800 font-bold">
            Sign In
          </Link>
        </p>
      </div>
